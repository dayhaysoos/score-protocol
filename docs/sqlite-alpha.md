...
`score.compilation-bundle` version `0.1.0-alpha.6`, targeting
`score.coding` version `0.1.0-alpha.6`. It groups exact source bindings, the
...
`0.1.0-alpha.6`. Approved Pass Export uses `0.1.0-alpha.7`; a Runner rejects an
